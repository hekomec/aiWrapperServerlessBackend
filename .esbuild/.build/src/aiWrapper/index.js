...
var require_cors = __commonJS({
  "utils/cors.js"(exports2, module2) {
    var cors2 = (body) => {
      const headers = {
        "Access-Control-Allow-Origin": "*",
        "Access-Control-Allow-Headers": "Content-Type, Authorization, x-amz-date, x-amz-security-token, x-amz-user-agent, x-api-key, access-control-allow-origin, access-control-allow-methods",
    ...
    var handler2 = () => {
      return Promise.resolve(cors2({}));
    };
    var corsModule = module2.exports = cors2;
    corsModule.handler = handler2;
  }
});

// utils/errors.js
var require_errors = __commonJS({
  "utils/errors.js"(exports2, module2) {
    module2.exports = {
      400: (msg) => ({
        statusCode: 400,
...
var require_helpers = __commonJS({
  "utils/helpers.js"(exports2, module2) {
    require_main().config();
    var axios = require_axios();
    var getResultFromOpenAI = async (systemPrompt, userInput) => {
      try {
    ...
    module2.exports = { getResultFromOpenAI };
  }
});

// src/aiWrapper/post.js
var require_post = __commonJS({
  "src/aiWrapper/post.js"(exports2, module2) {
    var errors2 = require_errors();
    var { getResultFromOpenAI } = require_helpers();
    module2.exports = (event) => {
      ...
      const getResult = async (body) => {
        ...
        try {
          if (!systemPrompt || !userInput) {
            return errors2[400]({ error: "Invalid JSON" });
          }
      ...
      switch (path) {
        case `/aiWrapper`:
          return getResult(event == null ? void 0 : event.body);
        default:
          return errors2[404]();
      }
    };
